...
prof_type = 'host'
"""
Go through particle data files
if 'profile type' == host, select only particles associated with host
if 'profile type' == sub, select only particles associated with the subhalo
"""
